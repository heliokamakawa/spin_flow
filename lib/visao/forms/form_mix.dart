...
import 'package:spin_flow/visao/componentes/campos/selecao_unica/campo_busca_opcoes.dart';
...
class _FormMixState extends State<FormMix> {
  ...
  final ControladorMix _controlador = ControladorMix();
  ...
  Future<void> _carregarMusicas() async {
    final musicas = await _controlador.listarMusicas();
    if (!mounted) return;
    setState(() {
