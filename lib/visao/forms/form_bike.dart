...
import 'package:spin_flow/controle/controlador_bike.dart';
...
class _FormBikeState extends State<FormBike> {
  ...
  final ControladorBike _controlador = ControladorBike();
  ...
  Future<void> _carregarFabricantes() async {
    final fabricantes = await _controlador.listarFabricantes();
    if (!mounted) return;
    setState(() {
