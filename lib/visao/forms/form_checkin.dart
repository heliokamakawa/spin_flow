...
import 'package:spin_flow/controle/controlador_checkin.dart';
...
class _FormCheckinState extends State<FormCheckin> {
  ...
  final ControladorCheckin _controlador = ControladorCheckin();
  ...
  Future<void> _carregarOpcoes() async {
    ...
    final turmas = await _controlador.listarTurmas();
    if (!mounted) return;
    setState(() {
      _alunos = alunos;
      _turmas = turmas;
