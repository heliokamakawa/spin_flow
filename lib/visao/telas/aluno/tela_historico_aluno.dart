...
import 'package:spin_flow/controle/controlador_historico_aluno.dart';
...
class _TelaHistoricoAlunoState extends State<TelaHistoricoAluno> with SingleTickerProviderStateMixin {
  final ControladorHistoricoAluno _controlador = ControladorHistoricoAluno();
  ...
  Future<void> _carregar() async {
    ...
    final checkins = aluno == null ? <DTOCheckin>[] : await _controlador.buscarCheckinsPorAluno(aluno.id ?? 0);
