...
import 'package:spin_flow/controle/controlador_agenda_aluno.dart';
...
class _TelaAgendaAlunoState extends State<TelaAgendaAluno> {
  final ControladorAgendaAluno _controlador = ControladorAgendaAluno();
  ...
  Future<void> _carregar() async {
    ...
    for (final turma in turmas) {
      ...
      final mixAtivo = await _controlador.buscarMixAtivoPorTurma(
        turma.id ?? 0,
        data: _dataSelecionada,
      );
