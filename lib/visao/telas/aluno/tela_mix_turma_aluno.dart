...
import 'package:spin_flow/controle/controlador_mix_turma_aluno.dart';
...
class _TelaMixTurmaAlunoState extends State<TelaMixTurmaAluno> {
  final ControladorMixTurmaAluno _controlador = ControladorMixTurmaAluno();
  ...
  Future<void> _carregar() async {
    ...
    final ativo = await _controlador.buscarMixAtivoPorTurma(_turma!.id ?? 0, data: _data);
    final historico = await _controlador.buscarMixesPorTurma(_turma!.id ?? 0);
