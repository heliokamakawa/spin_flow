...
import 'package:spin_flow/controle/controlador_autenticacao.dart';
import 'package:spin_flow/core/configuracoes/erro.dart';
...
import 'package:spin_flow/visao/componentes/campos/comum/campo_senha.dart';
...
class _TelaLoginState extends State<TelaLogin> {
  ...
  final ControladorAutenticacao _controlador = ControladorAutenticacao();
  ...
  Future<void> _fazerLogin() async {
    ...
    final usuario = await _controlador.autenticar(
