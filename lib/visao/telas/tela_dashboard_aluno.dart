...
import 'package:spin_flow/controle/controlador_dashboard_aluno.dart';
...
class _TelaDashboardAlunoState extends State<TelaDashboardAluno> {
  final ControladorDashboardAluno _controlador = ControladorDashboardAluno();
  ...
  Future<void> _carregarResumo() async {
    ...
    final aluno = email == null ? null : await _controlador.buscarAlunoPorEmailAtivo(email);
    ...
    if (aluno != null) {
      final checkins = await _controlador.buscarCheckinsPorAluno(aluno.id ?? 0);
