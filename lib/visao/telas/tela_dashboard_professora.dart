...
import 'package:spin_flow/controle/controlador_dashboard_professora.dart';
...
class _TelaDashboardProfessoraState extends State<TelaDashboardProfessora> with SingleTickerProviderStateMixin {
  ...
  final ControladorDashboardProfessora _controlador = ControladorDashboardProfessora();
  ...
  Future<void> _carregarMetricas() async {
    ...
    try {
      final alunos = await _controlador.buscarTodosAlunos();
      final turmas = await _controlador.buscarTodasTurmas();
      final mixes = await _controlador.buscarTodosMixes();
      final bikes = await _controlador.buscarTodasBikes();
      final bikesManut = await _controlador.buscarBikeIdsEmManutencaoAtiva();
      final checkins = await _controlador.buscarTodosCheckins();
